...
function type_3_player($atts) {
    ...
    // Check if we should show podcast subscribe buttons
    $show_subscribe = false;
    $subscribe_urls = array();

    // Check either the provided post_id or the current global post
    ...
    if ($check_post_id && t3a_should_show_podcast_subscribe($check_post_id)) {
        $show_subscribe = true;
